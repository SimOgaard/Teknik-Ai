...
void infoCheck(){
  ...
  if(getRes.statusCode == 404){
    ...
    updateInterval = getRes.payload.substring(getRes.payload.indexOf("\"updateInterval\":") + 17, getRes.payload.indexOf(',', getRes.payload.indexOf("\"updateInterval\":") + 17)).toInt()*1000000;
    infoSend();
  }
}
...
void values(){
  ...
  Co2 = readPPMSerial();
  getTemperature();
  Serial.print("Temp:" + String(Temp) + ", Hum:" + String(Hum) + ", LDR:" + String(Lux) + ", CO2:" + String(Co2));
}
